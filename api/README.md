...
- `AssessmentSheetListItemResponse` (ASH-FB-W5) có thêm `studentNickName` (lấy từ `StudentSnapshot.NickName`, không migration) — UI danh sách hiển thị sau mã học sinh.
