...
internal sealed class AssessmentSheetConfiguration : IEntityTypeConfiguration<AssessmentSheet>
{
    public void Configure(EntityTypeBuilder<AssessmentSheet> builder)
    {
