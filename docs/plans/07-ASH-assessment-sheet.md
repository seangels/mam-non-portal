...
| `ASH-FB-W1-G8` | Cơ chế lưu Drive PDF | `SavePdfToDriveAsync` bỏ `Files.Update`: luôn tạo file mới rồi xóa file cũ theo id (404 → bỏ qua). `PlanFileLinkPdf`/`ResultFileLinkPdf` đổi mỗi lần upload. | **Đã code** — `ASH-FB-W1` (2026-08-31) |
